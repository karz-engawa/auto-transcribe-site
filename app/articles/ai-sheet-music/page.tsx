...
自動採譜とMIDIを使った作成手順
        ...
        <section className="prose prose-gray max-w-none">
          <h2>AIで楽譜は作れる？</h2>
          <p>AIを使えば、音声ファイルから音程やタイミングを推定し、MIDIを生成できます。ただし、一発で完成楽譜になるわけではありません。</p>

          <h2>基本的な作成手順</h2>
          <p>MP3やWAVなどの音源を用意し、自動採譜ツールでMIDI化します。その後、MuseScoreやDAWに読み込んで不要な音やリズムを修正します。</p>

          <h2>AI自動採譜の注意点</h2>
          <p>AIは曲によって誤検出することがあります。複数楽器が重なった音源やノイズの多い音源では、MIDIが複雑になる場合があります。</p>

          <h2>まとめ</h2>
          <p>AIで楽譜を作るには、自動採譜でMIDIを作り、MuseScoreで整える流れがおすすめです。AIで下書き、人間が仕上げるという考え方が実用的です。</p>
        </section>
