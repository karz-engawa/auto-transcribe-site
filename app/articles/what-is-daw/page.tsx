    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <article className="mx-auto max-w-4xl px-6 py-12 md:px-8">
        ...
        <section className="prose prose-gray max-w-none">
          <h2>DAWとは？</h2>
          <p>DAWはDigital Audio Workstationの略で、録音、MIDI打ち込み、音源編集、エフェクト処理、ミックスなどを行う音楽制作ソフトです。</p>

          <h2>DAWでできること</h2>
          <p>DAWでは、ボーカルや楽器を録音したり、MIDIでピアノやドラムを打ち込んだりできます。音量バランスの調整や書き出しも行えます。</p>

          <h2>MIDIとDAWの関係</h2>
          <p>MIDIはDAW上で音を鳴らすための演奏情報として使われます。自動採譜ツールで生成したMIDIをDAWに読み込めば、音色変更やリズム修正がしやすくなります。</p>

          <h2>まとめ</h2>
          <p>DAWは音楽制作の中心になるソフトです。MIDI、自動採譜、DAWを組み合わせることで、耳コピや作曲の作業を効率化できます。</p>
        </section>
